  ...
  return (
    ...
    >
      <Link
        ...
        className="group block surface-card overflow-hidden hover:border-primary/30 transition-all duration-300"
      >
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-3">
            <span className="pill-primary text-xs px-3 py-1 rounded-full font-semibold">{project.category}</span>
