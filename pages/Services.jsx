    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {core.map((s, i) => (
              ...
              >
                <Link href={s.path} className="group flex gap-5 surface-card p-6 hover:border-primary/30 transition-all duration-300">
                  <div className="icon-shell mt-0.5">
      ...
      <section className="py-16 bg-card/30 border-y border-border/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/packages" className="btn-primary rounded-lg px-7 py-3 text-sm font-semibold">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {specialized.map((s, i) => (
              <motion.div
                ...
                transition={{ delay: i * 0.07 }}
              >
                <Link href={s.path} className="group block surface-card p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  <div className="icon-shell mb-4">
