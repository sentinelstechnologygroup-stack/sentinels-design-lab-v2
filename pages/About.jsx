          ...
          <div className="grid lg:grid-cols-2 gap-10 items-end">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                ...
                <Link
                  href="/contact"
                  className="btn-secondary rounded-lg px-7 py-3 font-semibold text-sm"
                >
                  Get In Touch
                </Link>
              </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v, i) => (
              <motion.div
                ...
                className="surface-card p-7 hover:border-primary/30 hover:-translate-y-1 transition-all duration-300"
              >
                  ...
                  >
                    <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-6">
                      ...
                      <div className={`${isLeft ? "block" : "invisible"}`}>
                        <div className="ml-auto max-w-md surface-card p-6 hover:border-primary/30 hover:-translate-y-1 transition-all duration-300">
                          <div className="text-amber-300 text-[11px] font-bold uppercase tracking-[0.2em] mb-2">
                            {m.year}
                          </div>
                      ...
                      <div className="relative z-10 flex items-center justify-center">
                        <div className="icon-shell-accent relative flex items-center justify-center w-14 h-14 rounded-full shadow-[0_0_0_8px_rgba(2,6,23,0.55)]">
                      ...
                      {/* Right Card */}
                      <div className={`${!isLeft ? "block" : "invisible"}`}>
                        <div className="max-w-md surface-card p-6 hover:border-primary/30 hover:-translate-y-1 transition-all duration-300">
                          <div className="text-amber-300 text-[11px] font-bold uppercase tracking-[0.2em] mb-2">
                            {m.year}
                          </div>
                          <h3 className="font-heading text-xl font-semibold text-foreground mb-3 leading-tight">
          ...
          <div className="md:hidden relative max-w-2xl mx-auto">
            ...
            <div className="space-y-8">
              {milestones.map((m, i) => (
                ...
                >
                  <div className="absolute left-0 top-3 z-10 icon-shell-accent flex items-center justify-center w-10 h-10 rounded-full shadow-[0_0_0_6px_rgba(2,6,23,0.45)]">
