    ...
    <div className="relative overflow-hidden text-white">
            ...
            >
              ...
              <div className="mb-8 flex flex-wrap gap-2">
                {heroTags.map((tag) => (
                  <span
                    key={tag}
                    className="surface-chip-sm inline-flex items-center gap-1.5 text-secondary-foreground"
                  >
              ...
              <div className="relative grid h-[560px] grid-cols-2 grid-rows-3 gap-3">
                {heroTiles.map((tile, index) => (
                  <div
                    ...
                    className={`group relative overflow-hidden surface-card ${tile.className}`}
                  >
                    <img
                      src={tile.src}
                      alt={tile.alt}
                ...
                <div className="absolute -left-5 top-1/2 z-10 -translate-y-1/2 surface-card px-4 py-3">
                ...
                <div className="absolute -right-4 bottom-16 z-10 surface-card px-4 py-3">
                  <div className="inline-flex items-center gap-2">
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-2 gap-6 px-4 text-center sm:px-6 md:grid-cols-4 lg:px-8">
          {trustStrip.map((item, i) => (
            <motion.div
              ...
              className="surface-card px-4 py-4 text-sm font-medium text-foreground"
            >
              {item}
            </motion.div>
          ))}
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service, i) => (
              ...
              >
                <Link
                  href={service.path}
                  className="group block h-full surface-card p-7 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-[0_20px_60px_rgba(0,0,0,0.28)]"
                >
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4">
            {bestFit.map((item, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.08 }}
                className="surface-card px-4 py-5 text-sm font-medium text-foreground"
              >
                {item}
              </motion.div>
            ))}
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <motion.div
              ...
              className="space-y-5"
            >
              <div className="overflow-hidden surface-card p-7">
                ...
                <div className="space-y-5">
                  {processSteps.map((item) => (
                    <div key={item.step} className="flex items-start gap-4">
                      <span className="pill-primary inline-flex shrink-0 rounded-md px-2.5 py-1 text-xs font-bold">
                        {item.step}
                      </span>
                      <div>
                        <h4 className="font-heading text-sm font-semibold text-foreground">
              ...
              <div className="panel-safe rounded-2xl p-7">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
                    ...
                    <div
                      key={item}
                      className="surface-card inline-flex items-start gap-2 px-3 py-3 text-sm text-muted-foreground"
                    >
      ...
      <section className="relative bg-transparent py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <div className="surface-card-strong px-6 py-12 sm:px-10">
            <span className="text-sm font-semibold uppercase tracking-[0.18em] text-primary">
              ROI Perspective
            </span>
            <h2 className="mb-5 mt-3 font-heading text-3xl font-bold text-foreground sm:text-4xl">
