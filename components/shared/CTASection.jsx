    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">
          {description ||
            "Tell us what you're building and we'll put together a plan that fits your goals and budget."}
        </p>

        <div className="flex flex-wrap justify-center gap-4">
          <Link
            href={ctaHref || "/start-project"}
            className="inline-flex items-center gap-2 bg-primary hover:bg-primary text-primary-foreground px-8 py-3.5 rounded-lg font-semibold transition-all hover:shadow-lg hover:shadow-primary/20"
          >
