...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (FORM_ENDPOINT) {
      // Formspree / custom backend submission
      ...
      // No endpoint configured — log and notify
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-10 max-w-lg">
                Ready to start your project? Send us a message and we'll follow up within one business day.
              </p>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
              <form onSubmit={handleSubmit} className="bg-card border border-border/50 rounded-2xl p-8 space-y-5">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="text-xs font-medium text-muted-foreground mb-1.5 block">Full Name <span className="text-primary">*</span></label>
                    <input
                  ...
                  <div>
                    <label className="text-xs font-medium text-muted-foreground mb-1.5 block">Email <span className="text-primary">*</span></label>
                    <input
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-xs font-medium text-muted-foreground mb-1.5 block">Service Interest</label>
                    <select
                ...
                <div>
                  <label className="text-xs font-medium text-muted-foreground mb-1.5 block">Message <span className="text-primary">*</span></label>
                  <textarea
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground py-3.5 rounded-lg font-semibold transition-all hover:shadow-lg hover:shadow-primary/20 disabled:opacity-50"
                >
