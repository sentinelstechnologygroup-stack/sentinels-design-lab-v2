  ...
  return (
    <main className="min-h-screen pt-28 pb-20">
      <section className="mx-auto max-w-6xl px-6">
        <div className="mb-12 max-w-3xl"><span className="eyebrow mb-5">Sentinel Intelligence System</span><h1 className="font-heading text-4xl font-bold text-foreground sm:text-5xl">Get your free website readiness snapshot</h1><p className="mt-5 text-lg leading-8 text-muted-foreground">See separate homepage-readiness scores alongside the critical SEO, traffic, local, paid-media, and conversion areas that still need verification. No misleading overall health score.</p></div>
