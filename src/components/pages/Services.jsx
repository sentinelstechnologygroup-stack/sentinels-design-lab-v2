    ...
    <div className="relative overflow-hidden text-white">
            ...
            {capabilityCards.map((card, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="rounded-2xl border border-white/10 bg-[#0b1220]/96 p-7 shadow-[0_16px_50px_rgba(0,0,0,0.22)] backdrop-blur-sm"
                >
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {whoItIsFor.map((item, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.08 }}
                className="rounded-2xl border border-white/10 bg-[#0b1220]/96 p-6 shadow-[0_10px_30px_rgba(0,0,0,0.18)] backdrop-blur-sm"
              >
      ...
      <section className="relative bg-transparent py-20">
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#0c1322]/97 px-8 py-12 shadow-[0_20px_60px_rgba(0,0,0,0.24)] backdrop-blur-sm sm:px-12">
      ...
      <section className="relative bg-transparent py-20">
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-[1.75rem] border border-white/10 bg-[#0c1322]/97 px-8 py-12 shadow-[0_20px_60px_rgba(0,0,0,0.24)] backdrop-blur-sm sm:px-12">
