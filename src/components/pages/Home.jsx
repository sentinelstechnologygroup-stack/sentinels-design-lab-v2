    ...
    <div className="relative overflow-hidden text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-2 gap-6 px-4 text-center sm:px-6 md:grid-cols-4 lg:px-8">
          {trustStrip.map((item, i) => (
            <motion.div
              ...
              className="rounded-xl border border-white/8 bg-[#0c1322]/97 px-4 py-4 text-sm font-medium text-foreground shadow-[0_8px_30px_rgba(0,0,0,0.14)] backdrop-blur-sm"
            >
              {item}
            </motion.div>
          ))}
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service, i) => (
              ...
              >
                <Link
                  href={service.path}
                  className="group block h-full rounded-2xl border border-white/10 bg-[#0b1220]/96 p-7 shadow-[0_16px_50px_rgba(0,0,0,0.22)] backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-[0_20px_60px_rgba(0,0,0,0.28)]"
                >
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4">
            {bestFit.map((item, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.08 }}
                className="rounded-xl border border-white/10 bg-[#0b1220]/96 px-4 py-5 text-sm font-medium text-foreground shadow-[0_10px_30px_rgba(0,0,0,0.16)] backdrop-blur-sm"
              >
                {item}
              </motion.div>
            ))}
      ...
      <section className="relative bg-transparent py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <div className="rounded-[1.75rem] border border-white/10 bg-[#0c1322]/97 px-6 py-12 shadow-[0_20px_60px_rgba(0,0,0,0.24)] backdrop-blur-sm sm:px-10">
            <span className="eyebrow mb-4">
